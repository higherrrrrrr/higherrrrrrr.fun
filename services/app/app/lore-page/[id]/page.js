        ...
        {isEditMode ? (
          ...
          <>
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              <div className="text-green-500/90 whitespace-pre-line">
                {formData.loreText}
              </div>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-green-500/30">
              <div className="flex justify-center">
                <button
                  ...
                  className="px-6 py-3 bg-green-500/20 hover:bg-green-500/30 text-green-500 rounded-lg border border-green-500/30 transition flex items-center"
                >
