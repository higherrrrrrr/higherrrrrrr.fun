...
export default function GalleryPage() {
  ...
  // Fetch ETH price and featured token state
  useEffect(() => {
  ...
  // Fetch latest tokens and their states
  useEffect(() => {
      ...
      <div className="min-h-screen bg-black text-green-500 font-mono">
        <div className="max-w-6xl mx-auto p-4 md:p-8">
          ...
          <div className="animate-pulse space-y-4">
            <div className="h-48 bg-green-500/5 rounded-lg border border-green-500/20" />
          </div>
        </div>
      </div>
    );
          ...
          {loadingLatest ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {latestTokens.length === 0 && (
                <div className="col-span-2 text-center text-green-500/50 py-8">
                  No tokens found
                </div>
              )}
            </div>
