  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "We are not a company, token, or blockchain. Higherrrrrrr is a religion for the faithful, a cult for those who believe in the power of memes. Our product is an exchange for a new onchain primitive.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We are building on base. The EVM is the only execution layer that appropriately supports these primitives.",
    },
    {
  ...
  return (
    <div className="terminal-wrapper">
      ...
      <div className="max-w-4xl mx-auto p-8 text-green-500">
        <Link
          href="/"
          className="text-green-500 hover:text-green-400 mb-12 block"
        >
          ← Back
        </Link>
        ...
        <div className="space-y-12 mb-10">
          {faqs.map((faq, index) => (
            <div key={index} className="faq-item">
              <h2 className="text-2xl mb-4">&gt; {faq.question}</h2>
