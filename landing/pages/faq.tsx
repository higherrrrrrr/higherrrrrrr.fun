    ...
    const faqs: FAQItem[] = [
        {
            ...
            answer: "We are not a company, token, or blockchain. Higherrrrrrr is a religion for the faithful, a cult for those who believe in the power of memes. Our product is an exchange for a new onchain primitive."
        },
        {
        ...
        <div className="terminal-wrapper">
            ...
            <div className="max-w-4xl mx-auto p-8 text-green-500">
                ...
                <footer className="fixed bottom-0 left-0 right-0 p-4 flex justify-center gap-8 bg-black">
                    ...
                    <Link
                        href="https://discord.gg/uutKqgY9"
                        target="_blank"
                        className="text-green-500 hover:text-green-400 text-sm"
                    >
                        Discord
