...
import type { DynamicMeme, DynamicMemeInterface } from "../DynamicMeme";
...
const _abi = [
  ...
  {
    type: "function",
    name: "getAllMemeLevels",
    inputs: [],
    outputs: [
      {
        name: "",
        type: "tuple[]",
        internalType: "struct DynamicMeme.MemeLevel[]",
        components: [
          {
            name: "priceThreshold",
            type: "uint256",
  ...
  },
  {
    ...
    outputs: [
      {
        name: "currentMemeName",
        type: "string",
        internalType: "string",
      },
      {
        name: "currentMemeType",
        type: "string",
        internalType: "string",
      },
      {
...
export class DynamicMeme__factory {
  static readonly abi = _abi;
  static createInterface(): DynamicMemeInterface {
    return new Interface(_abi) as DynamicMemeInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): DynamicMeme {
    return new Contract(address, _abi, runner) as unknown as DynamicMeme;
  }
}
