...
export interface EvolutionaryMemeInterface extends Interface {
...
export interface EvolutionaryMeme extends BaseContract {
  connect(runner?: ContractRunner | null): EvolutionaryMeme;
  waitForDeployment(): Promise<this>;

  interface: EvolutionaryMemeInterface;
